 ...
 * .bind is not needed. This class is not generally meant to be extended.
 */
export class Client {
 ...
 * (a) client.on() handlers
 * (b) errors during calls to TDLib
 * (c) other internal tdl errors
 */
