...
export class Client {
  ...
  /**
   * @deprecated Use `tdl.configure` and `tdl.createClient` instead. See the tdl
   * 7.3 entry in `CHANGELOG.md` for additional information. The new approach to
   * create a client is:
   * ```
